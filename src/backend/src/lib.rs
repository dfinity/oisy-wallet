...
use shared::{
    ...
    types::{
        ...
        result_types::{
            ...
            GetUserTransactionsResult, PeekPersonalNoteShareResult, PersonalNotesVetkeyResult,
            SaveUserTransactionsResult, SetPersonalNoteResult, SetUserShowTestnetsResult,
            SignOnramperWidgetUrlResult, UpdateContactResult,
