...
export interface SwapFactory {
	...
	getActiveWasm: ActorMethod<[], Uint8Array>;
	...
	getInstallerModuleHash: ActorMethod<[], [] | [Uint8Array]>;
	...
	getStagingWasm: ActorMethod<[], Uint8Array>;
	...
	setInstallerModuleHash: ActorMethod<[Uint8Array], undefined>;
	setInstallerModuleHashValidate: ActorMethod<[Uint8Array], { Ok: string } | { Err: string }>;
	...
	uploadWasmChunk: ActorMethod<[Uint8Array], bigint>;
}
