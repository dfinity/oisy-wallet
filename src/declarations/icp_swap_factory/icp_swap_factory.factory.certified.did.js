...
export const idlFactory = ({ IDL }) => {
	...
	const SwapFactory = IDL.Service({
		...
		getActiveWasm: IDL.Func([], [IDL.Vec(IDL.Nat8)]),
		getAdmins: IDL.Func([], [IDL.Vec(IDL.Principal)]),
		getCreatePoolRecords: IDL.Func([], [IDL.Vec(CreatePoolRecord)]),
		getCreatePoolRecordsByCaller: IDL.Func([IDL.Principal], [IDL.Vec(CreatePoolRecord)]),
		getCurrentUpgradeTask: IDL.Func([], [Result_13]),
		getCycleInfo: IDL.Func([], [Result_12], []),
		getGovernanceCid: IDL.Func([], [Result_11]),
		getInitArgs: IDL.Func([], [Result_10]),
		getInstallerModuleHash: IDL.Func([], [IDL.Opt(IDL.Vec(IDL.Nat8))]),
		getNextPoolVersion: IDL.Func([], [IDL.Text]),
		getPasscodesByPrincipal: IDL.Func([IDL.Principal], [Result_9]),
		getPendingUpgradePoolList: IDL.Func([], [Result_7]),
		getPool: IDL.Func([GetPoolArgs], [Result_8]),
		getPoolInstallers: IDL.Func([], [IDL.Vec(PoolInstaller)]),
		getPoolUpgradeTaskHis: IDL.Func([IDL.Principal], [Result_7]),
		getPoolUpgradeTaskHisList: IDL.Func([], [Result_6]),
		getPools: IDL.Func([], [Result_4]),
		getPrincipalPasscodes: IDL.Func([], [Result_5]),
		getRemovedPools: IDL.Func([], [Result_4]),
		getStagingWasm: IDL.Func([], [IDL.Vec(IDL.Nat8)]),
		getUpgradeFailedPoolList: IDL.Func([], [Result_3]),
		getVersion: IDL.Func([], [IDL.Text]),
		getWasmActiveStatus: IDL.Func([], [IDL.Bool]),
