...
export const Passcode = IDL.Record({
	fee: IDL.Nat,
...
export const PoolInstaller = IDL.Record({
	weight: IDL.Nat,
	subnet: IDL.Text,
	subnetType: IDL.Text,
...
export const CreatePoolArgs = IDL.Record({
	fee: IDL.Nat,
...
export const PoolData = IDL.Record({
	fee: IDL.Nat,
	key: IDL.Text,
	tickSpacing: IDL.Int,
	token0: Token,
...
export const Result_8 = IDL.Variant({ ok: PoolData, err: Error });
export const CreatePoolRecord = IDL.Record({
...
export const PoolUpgradeTaskStep = IDL.Record({
	isDone: IDL.Bool,
	timestamp: IDL.Nat
});
export const PoolUpgradeTask = IDL.Record({
...
export const Result_12 = IDL.Variant({ ok: CycleInfo, err: Error });
...
export const GetPoolArgs = IDL.Record({
	fee: IDL.Nat,
	token0: Token,
	token1: Token
});
...
export const FailedPoolInfo = IDL.Record({
...
export const UpgradePoolArgs = IDL.Record({
	poolIds: IDL.Vec(IDL.Principal)
});
export const Result = IDL.Variant({ ok: IDL.Text, err: Error });
export const SwapFactory = IDL.Service({
...
export const idlService = SwapFactory;
