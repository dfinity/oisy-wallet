...
export const idlFactory = ({ IDL }) => {
	...
	return IDL.Service({
		...
		balanceOf: IDL.Func([IDL.Principal], [Result]),
		burn: IDL.Func([IDL.Nat], [Result], []),
		custodians: IDL.Func([], [IDL.Vec(IDL.Principal)]),
		cycles: IDL.Func([], [IDL.Nat]),
		dfx_info: IDL.Func([], [IDL.Text]),
		dip721_approve: IDL.Func([IDL.Principal, IDL.Nat], [Result], []),
		dip721_balance_of: IDL.Func([IDL.Principal], [Result]),
		dip721_burn: IDL.Func([IDL.Nat], [Result], []),
		dip721_custodians: IDL.Func([], [IDL.Vec(IDL.Principal)]),
		dip721_cycles: IDL.Func([], [IDL.Nat]),
		dip721_is_approved_for_all: IDL.Func([IDL.Principal, IDL.Principal], [Result_1]),
		dip721_logo: IDL.Func([], [IDL.Opt(IDL.Text)]),
		dip721_metadata: IDL.Func([], [ManualReply]),
		dip721_mint: IDL.Func(
			[IDL.Principal, IDL.Nat, IDL.Vec(IDL.Tuple(IDL.Text, GenericValue))],
			[Result],
			[]
		),
		dip721_name: IDL.Func([], [IDL.Opt(IDL.Text)]),
		dip721_operator_of: IDL.Func([IDL.Nat], [Result_2]),
		dip721_operator_token_identifiers: IDL.Func([IDL.Principal], [ManualReply_1]),
		dip721_operator_token_metadata: IDL.Func([IDL.Principal], [ManualReply_2]),
		dip721_owner_of: IDL.Func([IDL.Nat], [Result_2]),
		dip721_owner_token_identifiers: IDL.Func([IDL.Principal], [ManualReply_1]),
		dip721_owner_token_metadata: IDL.Func([IDL.Principal], [ManualReply_2]),
		...
		dip721_stats: IDL.Func([], [Stats]),
		dip721_supported_interfaces: IDL.Func([], [IDL.Vec(SupportedInterface)]),
		dip721_symbol: IDL.Func([], [IDL.Opt(IDL.Text)]),
		dip721_token_metadata: IDL.Func([IDL.Nat], [ManualReply_3]),
		dip721_total_supply: IDL.Func([], [IDL.Nat]),
		dip721_total_transactions: IDL.Func([], [IDL.Nat]),
		dip721_total_unique_holders: IDL.Func([], [IDL.Nat]),
		...
		git_commit_hash: IDL.Func([], [IDL.Text]),
		isApprovedForAll: IDL.Func([IDL.Principal, IDL.Principal], [Result_1]),
		logo: IDL.Func([], [IDL.Opt(IDL.Text)]),
		metadata: IDL.Func([], [ManualReply]),
		mint: IDL.Func(
			[IDL.Principal, IDL.Nat, IDL.Vec(IDL.Tuple(IDL.Text, GenericValue))],
			[Result],
			[]
		...
		operatorOf: IDL.Func([IDL.Nat], [Result_2]),
		operatorTokenIdentifiers: IDL.Func([IDL.Principal], [ManualReply_1]),
		operatorTokenMetadata: IDL.Func([IDL.Principal], [ManualReply_2]),
		ownerOf: IDL.Func([IDL.Nat], [Result_2]),
		ownerTokenIdentifiers: IDL.Func([IDL.Principal], [ManualReply_1]),
		ownerTokenMetadata: IDL.Func([IDL.Principal], [ManualReply_2]),
		rust_toolchain_info: IDL.Func([], [IDL.Text]),
		...
		supportedInterfaces: IDL.Func([], [IDL.Vec(SupportedInterface)]),
		symbol: IDL.Func([], [IDL.Opt(IDL.Text)]),
		tokenMetadata: IDL.Func([IDL.Nat], [ManualReply_3]),
		totalSupply: IDL.Func([], [IDL.Nat]),
		totalTransactions: IDL.Func([], [IDL.Nat]),
		totalUniqueHolders: IDL.Func([], [IDL.Nat]),
