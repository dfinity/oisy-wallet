...
export const idlFactory = ({ IDL }) => {
	...
	return IDL.Service({
		...
		get_balances: IDL.Func([IDL.Opt(IDL.Vec(FilterToken))], [GetBalancesResult]),
		get_events: IDL.Func([GetEventsArgs], [GetEventsResult]),
		get_fee_balances: IDL.Func([IDL.Opt(IDL.Vec(FilterToken))], [GetBalancesResult]),
		get_my_orders: IDL.Func(
			[IDL.Opt(GetMyOrdersArgs)],
			[IDL.Variant({ Ok: IDL.Vec(UserOrder), Err: GetMyOrdersError })]
		),
		get_order_book_depth: IDL.Func([GetOrderBookDepthRequest], [GetOrderBookDepthResult]),
		get_order_book_ticker: IDL.Func([TradingPair], [GetOrderBookTickerResult]),
