...
export const SetPermissions = IDL.Record({
...
export const AssetCanisterArgs = IDL.Variant({
	Upgrade: UpgradeArgs,
	Init: InitArgs
});
export const ClearArguments = IDL.Record({});
export const BatchId = IDL.Nat;
export const Key = IDL.Text;
export const HeaderField = IDL.Tuple(IDL.Text, IDL.Text);
export const SetAssetPropertiesArguments = IDL.Record({
	key: Key,
...
export const CreateAssetArguments = IDL.Record({
	key: Key,
...
export const UnsetAssetContentArguments = IDL.Record({
	key: Key,
	content_encoding: IDL.Text
});
export const DeleteAssetArguments = IDL.Record({ key: Key });
export const ChunkId = IDL.Nat;
export const SetAssetContentArguments = IDL.Record({
	key: Key,
	sha256: IDL.Opt(IDL.Vec(IDL.Nat8)),
	chunk_ids: IDL.Vec(ChunkId),
	content_encoding: IDL.Text
});
export const BatchOperationKind = IDL.Variant({
...
export const CommitBatchArguments = IDL.Record({
	batch_id: BatchId,
	operations: IDL.Vec(BatchOperationKind)
});
export const CommitProposedBatchArguments = IDL.Record({
	batch_id: BatchId,
	evidence: IDL.Vec(IDL.Nat8)
});
export const ComputeEvidenceArguments = IDL.Record({
	batch_id: BatchId,
	max_iterations: IDL.Opt(IDL.Nat16)
});
export const ConfigureArguments = IDL.Record({
	max_batches: IDL.Opt(IDL.Opt(IDL.Nat64)),
	max_bytes: IDL.Opt(IDL.Opt(IDL.Nat64)),
	max_chunks: IDL.Opt(IDL.Opt(IDL.Nat64))
});
export const DeleteBatchArguments = IDL.Record({ batch_id: BatchId });
export const ConfigurationResponse = IDL.Record({
...
export const GrantPermission = IDL.Record({
...
export const ListPermitted = IDL.Record({ permission: Permission });
export const RevokePermission = IDL.Record({
	permission: Permission,
	of_principal: IDL.Principal
});
export const ValidationResult = IDL.Variant({
	Ok: IDL.Text,
	Err: IDL.Text
});
...
export const idlInitArgs = [IDL.Opt(AssetCanisterArgs)];
