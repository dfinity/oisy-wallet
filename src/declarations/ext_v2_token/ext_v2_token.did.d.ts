...
export interface EXTNFT {
	...
	ext_mint: ActorMethod<[Array<[AccountIdentifier__1, Metadata]>], Uint32Array>;
...
export type MetadataValue = [
	string,
	{ nat: bigint } | { blob: Uint8Array } | { nat8: number } | { text: string }
];
...
export type PaymentType = { nft: TokenIndex } | { nfts: Uint32Array } | { sale: bigint };
export type Result =
	| {
			ok: Array<[TokenIndex, [] | [Listing], [] | [Uint8Array]]>;
	  }
	| { err: CommonError };
export type Result_1 = { ok: Uint32Array } | { err: CommonError };
