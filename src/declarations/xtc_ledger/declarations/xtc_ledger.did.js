...
export const TxReceipt = IDL.Variant({ Ok: IDL.Nat, Err: TxError });
export const TransactionId = IDL.Nat64;
export const BurnError = IDL.Variant({
	InsufficientBalance: IDL.Null,
	InvalidTokenContract: IDL.Null,
	NotSufficientLiquidity: IDL.Null
});
export const BurnResult = IDL.Variant({
	Ok: TransactionId,
	Err: BurnError
});
...
export const EventDetail = IDL.Variant({
...
export const EventsConnection = IDL.Record({
	data: IDL.Vec(Event),
...
export const MintError = IDL.Variant({ NotSufficientLiquidity: IDL.Null });
...
export const TxReceiptLegacy = IDL.Variant({
	Ok: IDL.Nat,
	Err: IDL.Variant({
		InsufficientAllowance: IDL.Null,
		InsufficientBalance: IDL.Null
...
export const ResultCall = IDL.Variant({
	Ok: IDL.Record({ return: IDL.Vec(IDL.Nat8) }),
	Err: IDL.Text
});
export const CreateResult = IDL.Variant({
	Ok: IDL.Record({ canister_id: IDL.Principal }),
	Err: IDL.Text
});
export const ResultSend = IDL.Variant({ Ok: IDL.Null, Err: IDL.Text });
