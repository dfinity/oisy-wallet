...
export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'configure_vips' : IDL.Func(
        [IDL.Vec(IDL.Tuple(IDL.Text, VipConfig))],
        [],
        [],
      ),
    ...
    'new_vip_reward' : IDL.Func(
        [IDL.Opt(ClaimedVipReward)],
        [NewVipRewardResponse],
        [],
      ),
    'referrer_info' : IDL.Func([], [ReferrerInfo], []),
    'referrer_info_for' : IDL.Func(
        [IDL.Principal],
        [IDL.Opt(ReferrerInfo)],
        ['query'],
      ),
    ...
    'usage_eligible' : IDL.Func(
        [IDL.Principal],
        [IDL.Bool, IDL.Bool],
        ['query'],
      ),
    'usage_stats' : IDL.Func([], [UsageAwardStats], ['query']),
    'usage_winners' : IDL.Func(
        [IDL.Opt(UsageWinnersRequest)],
