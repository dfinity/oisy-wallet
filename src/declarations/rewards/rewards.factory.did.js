...
export const idlFactory = ({ IDL }) => {
  ...
  const UsageAwardConfig = IDL.Record({
    ...
    'probability_multiplier_rules' : IDL.Vec(
      IDL.Tuple(IDL.Nat32, IDL.Vec(CriterionName))
    ),
  ...
  return IDL.Service({
    ...
    'grant_usage_award' : IDL.Func(
        [UsageAwardEvent, IDL.Opt(IDL.Principal)],
        [],
        [],
      ),
    ...
    'my_qr_gift_codes' : IDL.Func([], [IDL.Vec(QrGiftCodeEntry)], ['query']),
    'new_vip_reward' : IDL.Func(
        [IDL.Opt(ClaimedVipReward)],
        [NewVipRewardResponse],
        [],
      ),
    'qr_gift_code_info' : IDL.Func(
        [IDL.Text],
        [IDL.Opt(QrGiftCodeInfoResponse)],
        ['query'],
      ),
    'qr_gift_code_stats' : IDL.Func([], [QrGiftCodeStats], ['query']),
    'redeem_qr_gift_code' : IDL.Func(
    ...
    'vip_code_info' : IDL.Func(
        [IDL.Text],
        [IDL.Opt(VipCodeInfoResponse)],
        ['query'],
      ),
