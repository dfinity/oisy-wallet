...
export type AccountSnapshotFor = { 'Icrc' : AccountSnapshot_Icrc } |
...
export type SetReferrerError = { 'SelfReferral' : null } |
  { 'AlreadyHasReferrer' : null } |
  { 'UnknownReferrer' : null } |
  { 'NotNewUser' : null } |
  { 'AnonymousCaller' : null };
export type SetReferrerResponse = { 'Ok' : null } |
...
export interface UsageVsHoldingStats { 'holdings' : Array<UsageAndHolding> }
...
export interface VipReward { 'code' : string }
