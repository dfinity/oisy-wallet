...
export const CandidDuration = IDL.Variant({
	Minutes: IDL.Nat64,
	Seconds: IDL.Nat64,
	Days: IDL.Nat64,
	Forever: IDL.Null,
...
export const CriterionName = IDL.Variant({
...
export const UsageAwardEvent = IDL.Record({
	name: IDL.Text,
...
export const AwardFilter = IDL.Record({
	award_name: IDL.Opt(IDL.Text),
	campaign_id: IDL.Opt(IDL.Text)
});
export const Criterion = IDL.Variant({
...
export const UsageCriteria = IDL.Record({ criteria: IDL.Vec(Criterion) });
export const UsageAwardConfig = IDL.Record({
...
export const ReferrerConfig = IDL.Record({
	referrers_per_event: IDL.Nat32,
	awards: IDL.Vec(TokenConfig),
	criteria: IDL.Vec(Criterion)
});
export const RefereeConfig = IDL.Record({
	referees_per_referrer: IDL.Nat32,
	awards: IDL.Vec(TokenConfig),
	criteria: IDL.Vec(Criterion)
});
export const S1E4ReferralConfig = IDL.Record({
...
export const VipReward = IDL.Record({ code: IDL.Text });
export const ClaimVipRewardResponse = IDL.Variant({
	AlreadyClaimed: IDL.Null,
	Success: IDL.Null,
	InvalidCode: IDL.Null
});
export const ClaimedVipReward = IDL.Record({ campaign_id: IDL.Text });
export const CriterionEligibility = IDL.Record({
	satisfied: IDL.Bool,
	criterion: Criterion
});
export const CampaignEligibility = IDL.Record({
...
export const EligibilityReport = IDL.Record({
	campaigns: IDL.Vec(IDL.Tuple(IDL.Text, CampaignEligibility))
});
export const EligibilityError = IDL.Variant({ NotAuthorized: IDL.Null });
export const EligibilityResponse = IDL.Variant({
	Ok: EligibilityReport,
	Err: EligibilityError
});
export const HoldingsPopcontestRequest = IDL.Record({
	to: IDL.Opt(IDL.Nat8),
	from: IDL.Opt(IDL.Nat8)
});
export const AnyToken = IDL.Record({
	token_symbol: IDL.Text,
	wraps: IDL.Opt(IDL.Text)
});
export const AnyNetwork = IDL.Record({
...
export const AccountId_Any = IDL.Text;
export const Transaction_Any = IDL.Record({
...
export const AccountSnapshot_Any = IDL.Record({
	decimals: IDL.Nat8,
...
export const Transaction_Icrc = IDL.Record({
	transaction_type: TransactionType,
	network: IDL.Record({}),
...
export const AccountSnapshot_Icrc = IDL.Record({
	decimals: IDL.Nat8,
...
export const Transaction_Spl = IDL.Record({
	transaction_type: TransactionType,
	network: IDL.Record({}),
...
export const AccountSnapshot_Spl = IDL.Record({
	decimals: IDL.Nat8,
...
export const SetReferrerResponse = IDL.Variant({
	Ok: IDL.Null,
	Err: SetReferrerError
});
export const StatsKeyType = IDL.Variant({
	TokenGroup: IDL.Null,
	Network: IDL.Null,
	TokenSymbol: IDL.Null
});
export const StatsRequest = IDL.Record({ by: StatsKeyType });
export const StatsValue = IDL.Record({
	user_count: IDL.Nat64,
	assets_usd: IDL.Float64
});
export const StatsResponse = IDL.Record({
	request: StatsRequest,
	stats: IDL.Vec(IDL.Tuple(IDL.Text, StatsValue))
});
export const UsageAndHolding = IDL.Record({
	first_activity_ns: IDL.Opt(IDL.Nat64),
	approx_usd_valuation: IDL.Float64,
	last_activity_ns: IDL.Opt(IDL.Nat64)
});
export const UsageVsHoldingStats = IDL.Record({
	holdings: IDL.Vec(UsageAndHolding)
});
export const UsageAwardStats = IDL.Record({
	user_count: IDL.Nat64,
...
export const UserDbKey = IDL.Record({
	pouh_verified: IDL.Bool,
	oisy_user: IDL.Principal
});
export const UsageWinnersRequest = IDL.Record({
	to_ns: IDL.Nat64,
	from_ns: IDL.Nat64,
	limit: IDL.Nat32,
	after_user: IDL.Opt(UserDbKey)
});
export const UsageWinnersResponse = IDL.Record({
...
export const S1E4ReferrerInfo = IDL.Record({
	unrewarded_referees: IDL.Vec(IDL.Principal),
	referrals_count: IDL.Nat32
});
export const UsageAwardState = IDL.Record({
	first_activity_ns: IDL.Opt(IDL.Nat64),
...
export const VipStats = IDL.Record({
...
export const idlService = IDL.Service({
	...
	claim_vip_reward: IDL.Func([VipReward], [ClaimVipRewardResponse, IDL.Opt(ClaimedVipReward)], []),
...
export const idlInitArgs = [IDL.Opt(Config)];
