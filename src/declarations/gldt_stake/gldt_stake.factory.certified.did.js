...
export const idlFactory = ({ IDL }) => {
	...
	return IDL.Service({
		_get_state_snapshot: IDL.Func([IDL.Null], [StateSnapshot]),
		...
		get_all_gldt_staked_history: IDL.Func([Args_2], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Nat))]),
		...
		get_apy_timeseries: IDL.Func([Args_3], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Float64))]),
		get_daily_analytics: IDL.Func([Args_3], [IDL.Vec(IDL.Tuple(IDL.Nat64, DailyAnalytics))]),
		get_neurons: IDL.Func([IDL.Null], [IDL.Vec(Neuron)]),
		get_position: IDL.Func([], [IDL.Opt(StakePositionResponse)]),
		...
		list_all_positions: IDL.Func([Args_5], [IDL.Vec(StakePositionResponse)]),
