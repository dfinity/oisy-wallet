...
export const idlFactory = ({ IDL }) => {
	...
	return IDL.Service({
		...
		get_apy_timeseries: IDL.Func([Args_2], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Float64))], ['query']),
		get_config: IDL.Func([IDL.Null], [Response], ['query']),
		...
		get_position: IDL.Func([IDL.Principal], [IDL.Opt(StakePositionResponse)], ['query']),
		...
		icrc21_canister_call_consent_message: IDL.Func([ConsentMessageRequest], [Result_2], ['query']),
		...
		list_all_positions: IDL.Func([Args_4], [IDL.Vec(StakePositionResponse)], ['query']),
