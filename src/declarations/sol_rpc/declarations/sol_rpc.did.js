...
export const Mode = IDL.Variant({ Demo: IDL.Null, Normal: IDL.Null });
...
export const NumSubnetNodes = IDL.Nat32;
...
export const SolanaCluster = IDL.Variant({
	Mainnet: IDL.Null,
	Testnet: IDL.Null,
	Devnet: IDL.Null
});
export const HttpHeader = IDL.Record({ value: IDL.Text, name: IDL.Text });
export const RpcEndpoint = IDL.Record({
	url: IDL.Text,
	headers: IDL.Opt(IDL.Vec(HttpHeader))
});
export const SupportedProvider = IDL.Variant({
...
export const RpcSource = IDL.Variant({
	Custom: RpcEndpoint,
	Supported: SupportedProvider
});
export const RpcSources = IDL.Variant({
...
export const GetAccountInfoEncoding = IDL.Variant({
	'base64+zstd': IDL.Null,
	jsonParsed: IDL.Null,
	base58: IDL.Null,
	base64: IDL.Null
});
export const Pubkey = IDL.Text;
export const DataSlice = IDL.Record({
	offset: IDL.Nat32,
	length: IDL.Nat32
});
export const Slot = IDL.Nat64;
export const CommitmentLevel = IDL.Variant({
	finalized: IDL.Null,
	confirmed: IDL.Null,
	processed: IDL.Null
});
export const GetAccountInfoParams = IDL.Record({
...
export const ParsedAccount = IDL.Record({
	space: IDL.Nat64,
	parsed: IDL.Text,
	program: Pubkey
});
export const AccountEncoding = IDL.Variant({
	'base64+zstd': IDL.Null,
	jsonParsed: IDL.Null,
	base58: IDL.Null,
	base64: IDL.Null,
...
export const AccountData = IDL.Variant({
	json: ParsedAccount,
...
export const GetAccountInfoResult = IDL.Variant({
	Ok: IDL.Opt(AccountInfo),
	Err: RpcError
});
export const MultiGetAccountInfoResult = IDL.Variant({
...
export const GetBalanceParams = IDL.Record({
	pubkey: Pubkey,
	minContextSlot: IDL.Opt(Slot),
	commitment: IDL.Opt(CommitmentLevel)
});
export const Lamport = IDL.Nat64;
export const GetBalanceResult = IDL.Variant({
	Ok: Lamport,
	Err: RpcError
});
export const MultiGetBalanceResult = IDL.Variant({
	Consistent: GetBalanceResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, GetBalanceResult))
});
export const TransactionDetails = IDL.Variant({
	none: IDL.Null,
	accounts: IDL.Null,
	signatures: IDL.Null
});
export const GetBlockParams = IDL.Record({
...
export const Timestamp = IDL.Int64;
export const Hash = IDL.Text;
export const Signature = IDL.Text;
...
export const InstructionError = IDL.Variant({
...
export const TransactionTokenBalance = IDL.Record({
...
export const CompiledInstruction = IDL.Record({
	data: IDL.Text,
	accounts: IDL.Vec(IDL.Nat8),
	programIdIndex: IDL.Nat8,
	stackHeight: IDL.Opt(IDL.Nat32)
});
export const Instruction = IDL.Variant({ compiled: CompiledInstruction });
export const InnerInstructions = IDL.Record({
	instructions: IDL.Vec(Instruction),
	index: IDL.Nat8
});
export const LoadedAddresses = IDL.Record({
	writable: IDL.Vec(Pubkey),
	readonly: IDL.Vec(Pubkey)
});
export const TransactionStatusMeta = IDL.Record({
	fee: IDL.Nat64,
...
export const GetBlockResult = IDL.Variant({
	Ok: IDL.Opt(ConfirmedBlock),
	Err: RpcError
});
export const MultiGetBlockResult = IDL.Variant({
...
export const RpcProvider = IDL.Record({
	access: RpcAccess,
	cluster: SolanaCluster
});
export const RoundingError = IDL.Nat64;
export const GetRecentPrioritizationFeesRpcConfig = IDL.Record({
	responseConsensus: IDL.Opt(ConsensusStrategy),
	maxSlotRoundingError: IDL.Opt(RoundingError),
	responseSizeEstimate: IDL.Opt(IDL.Nat64),
	maxLength: IDL.Opt(IDL.Nat8)
});
export const GetRecentPrioritizationFeesParams = IDL.Vec(Pubkey);
export const MicroLamport = IDL.Nat64;
export const PrioritizationFee = IDL.Record({
	prioritizationFee: MicroLamport,
	slot: Slot
});
export const GetRecentPrioritizationFeesResult = IDL.Variant({
	Ok: IDL.Vec(PrioritizationFee),
	Err: RpcError
});
export const MultiGetRecentPrioritizationFeesResult = IDL.Variant({
	Consistent: GetRecentPrioritizationFeesResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, GetRecentPrioritizationFeesResult))
});
export const GetSignatureStatusesParams = IDL.Record({
	searchTransactionHistory: IDL.Opt(IDL.Bool),
	signatures: IDL.Vec(Signature)
});
export const TransactionConfirmationStatus = IDL.Variant({
	finalized: IDL.Null,
	confirmed: IDL.Null,
	processed: IDL.Null
});
export const TransactionStatus = IDL.Record({
	err: IDL.Opt(TransactionError),
	status: IDL.Variant({ Ok: IDL.Null, Err: TransactionError }),
	confirmationStatus: IDL.Opt(TransactionConfirmationStatus),
	slot: Slot
});
export const GetSignatureStatusesResult = IDL.Variant({
	Ok: IDL.Vec(IDL.Opt(TransactionStatus)),
	Err: RpcError
});
export const MultiGetSignatureStatusesResult = IDL.Variant({
	Consistent: GetSignatureStatusesResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, GetSignatureStatusesResult))
});
export const GetSignaturesForAddressParams = IDL.Record({
	pubkey: Pubkey,
...
export const ConfirmedTransactionStatusWithSignature = IDL.Record({
	err: IDL.Opt(TransactionError),
	signature: Signature,
	confirmationStatus: IDL.Opt(TransactionConfirmationStatus),
...
export const GetSignaturesForAddressResult = IDL.Variant({
	Ok: IDL.Vec(ConfirmedTransactionStatusWithSignature),
	Err: RpcError
});
export const MultiGetSignaturesForAddressResult = IDL.Variant({
	Consistent: GetSignaturesForAddressResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, GetSignaturesForAddressResult))
});
export const GetSlotRpcConfig = IDL.Record({
	roundingError: IDL.Opt(RoundingError),
	responseConsensus: IDL.Opt(ConsensusStrategy),
	responseSizeEstimate: IDL.Opt(IDL.Nat64)
});
export const GetSlotParams = IDL.Record({
	minContextSlot: IDL.Opt(Slot),
	commitment: IDL.Opt(CommitmentLevel)
});
export const GetSlotResult = IDL.Variant({ Ok: Slot, Err: RpcError });
export const MultiGetSlotResult = IDL.Variant({
	Consistent: GetSlotResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, GetSlotResult))
});
export const GetTokenAccountBalanceParams = IDL.Record({
	pubkey: Pubkey,
	commitment: IDL.Opt(CommitmentLevel)
});
export const GetTokenAccountBalanceResult = IDL.Variant({
	Ok: TokenAmount,
	Err: RpcError
});
export const MultiGetTokenAccountBalanceResult = IDL.Variant({
	Consistent: GetTokenAccountBalanceResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, GetTokenAccountBalanceResult))
});
export const GetTransactionParams = IDL.Record({
	signature: Signature,
	maxSupportedTransactionVersion: IDL.Opt(IDL.Nat8),
	encoding: IDL.Opt(IDL.Variant({ base58: IDL.Null, base64: IDL.Null })),
	commitment: IDL.Opt(CommitmentLevel)
});
export const EncodedConfirmedTransactionWithStatusMeta = IDL.Record({
	transaction: EncodedTransactionWithStatusMeta,
	slot: Slot,
	blockTime: IDL.Opt(Timestamp)
});
export const GetTransactionResult = IDL.Variant({
	Ok: IDL.Opt(EncodedConfirmedTransactionWithStatusMeta),
	Err: RpcError
});
export const MultiGetTransactionResult = IDL.Variant({
...
export const MultiRequestResult = IDL.Variant({
	Consistent: RequestResult,
	Inconsistent: IDL.Vec(IDL.Tuple(RpcSource, RequestResult))
});
export const SendTransactionEncoding = IDL.Variant({
	base58: IDL.Null,
	base64: IDL.Null
});
export const SendTransactionParams = IDL.Record({
...
export const SendTransactionResult = IDL.Variant({
	Ok: Signature,
	Err: RpcError
});
export const MultiSendTransactionResult = IDL.Variant({
...
export const idlInitArgs = [InstallArgs];
