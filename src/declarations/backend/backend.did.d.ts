...
export type AccountSnapshotFor = { 'Erc20Sepolia' : AccountSnapshot } |
...
export type AddDappSettingsError = { 'MaxHiddenDappIds' : null } |
...
export type AddUserCredentialResult = { 'Ok' : null } |
  { 'Err' : AddUserCredentialError };
export type AllowSigningError = { 'ApproveError' : ApproveError } |
  { 'PowChallenge' : ChallengeCompletionError } |
  { 'Other' : string } |
  { 'FailedToContactCyclesLedger' : null };
export interface AllowSigningRequest { 'nonce' : bigint }
...
export type AllowSigningStatus = { 'Skipped' : null } |
  { 'Failed' : null } |
  { 'Executed' : null };
...
export type BtcAddress = { 'P2WPKH' : string } |
  { 'P2PKH' : string } |
  { 'P2WSH' : string } |
  { 'P2SH' : string } |
  { 'P2TR' : string };
...
export type ChallengeCompletionError = { 'InvalidNonce' : null } |
...
export type ContactError = { 'InvalidContactData' : null } |
  { 'ContactNotFound' : null };
export type CreateChallengeError = { 'ChallengeInProgress' : null } |
  { 'MissingUserProfile' : null } |
...
export interface CreateContactRequest { 'name' : string }
...
export interface DappCarouselSettings { 'hidden_dapp_ids' : Array<string> }
export interface DappSettings { 'dapp_carousel' : DappCarouselSettings }
...
export type GetAllowedCyclesError = { 'Other' : string } |
  { 'FailedToContactCyclesLedger' : null };
export interface GetAllowedCyclesResponse { 'allowed_cycles' : bigint }
export type GetUserProfileError = { 'NotFound' : null };
export interface HasUserProfileResponse { 'has_user_profile' : boolean }
...
export type IcrcTokenId = {
  ...
  { 'Native' : null };
export type Icrcv2AccountId = { 'Account' : Uint8Array | number[] } |
  {
    'WithPrincipal' : {
      'owner' : Principal,
...
export interface NetworkSettings { 'enabled' : boolean, 'is_testnet' : boolean }
export type NetworkSettingsFor = { 'InternetComputer' : null } |
  { 'BaseSepolia' : null } |
  { 'SolanaTestnet' : null } |
  { 'BitcoinRegtest' : null } |
  { 'SolanaDevnet' : null } |
...
export type Result_1 = { 'Ok' : AllowSigningResponse } |
...
export type Result_3 = { 'Ok' : BtcGetPendingTransactionsReponse } |
  { 'Err' : BtcAddPendingTransactionError };
export type Result_4 = { 'Ok' : SelectedUtxosFeeResponse } |
  { 'Err' : SelectedUtxosFeeError };
export type Result_5 = { 'Ok' : Contact } |
  { 'Err' : ContactError };
export type Result_6 = { 'Ok' : CreateChallengeResponse } |
  { 'Err' : CreateChallengeError };
export type Result_7 = { 'Ok' : bigint } |
  { 'Err' : ContactError };
export type Result_8 = { 'Ok' : GetAllowedCyclesResponse } |
...
export type SaveTestnetsSettingsError = { 'VersionMismatch' : null } |
  { 'UserNotFound' : null };
export type SelectedUtxosFeeError = { 'PendingTransactions' : null } |
  { 'InternalError' : { 'msg' : string } };
...
export interface TestnetsSettings { 'show_testnets' : boolean }
export type Token = { 'Icrc' : IcrcToken } |
  { 'SplDevnet' : SplToken } |
  { 'SplMainnet' : SplToken };
export type TokenAccountId = { 'Btc' : BtcAddress } |
  { 'Eth' : EthAddress } |
  { 'Sol' : string } |
...
export type TopUpCyclesLedgerResult = { 'Ok' : TopUpCyclesLedgerResponse } |
...
export interface _SERVICE {
  ...
  'create_contact' : ActorMethod<[CreateContactRequest], Result_5>,
  'create_pow_challenge' : ActorMethod<[], Result_6>,
  'create_user_profile' : ActorMethod<[], UserProfile>,
  'delete_contact' : ActorMethod<[bigint], Result_7>,
  'get_account_creation_timestamps' : ActorMethod<
    [],
    Array<[Principal, bigint]>
  >,
  'get_allowed_cycles' : ActorMethod<[], Result_8>,
  'get_canister_status' : ActorMethod<[], CanisterStatusResultV2>,
  'get_contact' : ActorMethod<[bigint], Result_5>,
  'get_contacts' : ActorMethod<[], Result_9>,
  'get_snapshot' : ActorMethod<[], [] | [UserSnapshot]>,
  'get_user_profile' : ActorMethod<[], Result_10>,
  ...
  >,
  'update_contact' : ActorMethod<[Contact], Result_5>,
