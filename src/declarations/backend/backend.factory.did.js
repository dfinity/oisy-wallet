...
export const idlFactory = ({ IDL }) => {
	...
	return IDL.Service({
		...
		filter_contacts_by_token_type: IDL.Func([IDL.Text], [IDL.Vec(Contact)], ['query']),
		...
		get_contact_by_id: IDL.Func([IDL.Text], [Result_8], ['query']),
		get_contact_settings: IDL.Func([], [ContactSettings], ['query']),
		...
		search_contacts_by_query: IDL.Func([IDL.Text], [IDL.Vec(Contact)], ['query']),
