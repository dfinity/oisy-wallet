...
describe('nft-send.services', () => {
	describe('encodeErc721SafeTransfer', () => {
		beforeEach(() => {
			vi.clearAllMocks();
		...
		it('encodes selector + args correctly', () => {
			const tokenId = '47744';
		...
		describe('encodeErc1155SafeTransfer', () => {
			beforeEach(() => {
				vi.clearAllMocks();
			...
			it('encodes selector + args correctly (default bytes data)', () => {
				const tokenId = '123';
				const amount = 2n;
			...
			it('accepts explicit bytes data', () => {
				const tokenId = '9';
				const amount = 1n;
				const extra = '0x1234';
