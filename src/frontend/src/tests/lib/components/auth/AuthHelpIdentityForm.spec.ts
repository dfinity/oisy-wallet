import {
    ...
    HELP_AUTH_IDENTITY_IMAGE_BANNER, HELP_AUTH_LEARN_MORE_LINK,
...
describe('AuthHelpIdentityForm', () => {
    ...
    it('should render auth help identity form content',() => {
        ...
        expect(getByText(replaceOisyPlaceholders(get(i18n).auth.help.text.identity_learn_more))).toBeInTheDocument();
