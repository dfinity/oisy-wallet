...
describe('ButtonAuthenticateWithLicense', () => {
    ...
    it('should render button authenticate with license content', () => {
        ...
        const licenseLinkAnchor: HTMLAnchorElement | null = container.querySelector(licenseLinkAnchorSelector);
        expect(licenseLinkAnchor).toBeInTheDocument();

        const SigningInHelpLinkSpan: HTMLSpanElement | null = container.querySelector(SigningInHelpLinkSpanSelector);
