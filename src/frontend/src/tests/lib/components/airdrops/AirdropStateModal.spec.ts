import {AIRDROPS_STATE_MODAL_IMAGE_BANNER, AIRDROPS_STATE_MODAL_SHARE_BUTTON} from '$lib/constants/test-ids.constants';
...
describe('AirdropStateModal', () => {
    ...
    it('should render modal content', () => {
        const mockedAirdrop: AirdropDescription | undefined = mockAirdropCampaigns.find((campaign) => campaign.id === 'OISY Airdrop #1');
