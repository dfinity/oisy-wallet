...
describe('AirdropsRequirements', () => {
    ...
    describe('RequirementsFulfilled', () => {
        const requirementStatusSelector = (index: number) => `span[data-tid="airdrop-requirement-status-${index}"]`;
        const requirementStatusSpinnerSelector = (index: number) => `span[data-tid="airdrop-requirement-status-spinner-${index}"]`;
        ...
        it('should render all requirements as fulfilled', () => {
            ...
            mockAirdropCampaign.requirements.forEach((requirement, index) => {
                const requirementStatus: HTMLSpanElement | null = container.querySelector(requirementStatusSelector(index));
        ...
        it('should render spinners if wrong amount of requirement states are available', () => {
            ...
            mockAirdropCampaign.requirements.forEach((requirement, index) => {
                const requirementStatusSpinner: HTMLSpanElement | null = container.querySelector(requirementStatusSpinnerSelector(index));
