...
import {
    TRANSACTION_MENU,
    TRANSACTION_MENU_HIDDEN_TRANSACTIONS, TRANSACTION_MENU_POPOVER
...
describe('TransactionMenu', () => {
    ...
    it('should not render menu items', () => {
        ...
        const menuItemHiddenTransactionsButton: HTMLButtonElement | null = container.querySelector(menuItemHiddenTransactionsSelector);
    ...
    it('should display and hide menu items', async () => {
        ...
        let menuItemHiddenTransactionsButton: HTMLButtonElement | null = container.querySelector(menuItemHiddenTransactionsSelector);
        expect(menuItemHiddenTransactionsButton).not.toBeInTheDocument();
