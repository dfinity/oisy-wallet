...
describe('RewardEarnings', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(tokensStore, 'tokens', 'get').mockImplementation(() => readable([BTC_MAINNET_TOKEN, mockCkBtcToken, mockCkUsdcToken]));
    });
    ...
    it('should render reward earnings content', async () => {
        ...
        const ckBtcRewardEarningsCard: HTMLDivElement | null = container.querySelector(ckBtcRewardEarningsCardSelector);
        const ckUsdcRewardEarningsCard: HTMLDivElement | null = container.querySelector(ckUsdcRewardEarningsCardSelector);
        const icpRewardEarningsCard: HTMLDivElement | null = container.querySelector(icpRewardEarningsCardSelector);

        const rewardEarningsActivityButton: HTMLButtonElement | null = container.querySelector(rewardEarningsActivityButtonSelector);
