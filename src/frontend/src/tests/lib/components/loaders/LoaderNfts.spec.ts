...
describe('LoaderNfts', () => {
	...
	describe('handleNewNfts', () => {
		...
		it('should add new erc721 nfts of loaded nft ids', async () => {
			erc721CustomTokensStore.setAll([{ data: mockedEnabledAzukiToken, certified: false }, { data: mockedEnabledGodsToken, certified: false }]);
		...
		it('should add new erc1155 nfts of loaded nft ids', async () => {
			erc1155CustomTokensStore.setAll([{data: mockedEnabledNyanToken, certified: false }, { data: mockedEnabledApeToken, certified: false }]);

			mockGetNftIdsForOwner.mockResolvedValueOnce([{ id: mockNftId1, balance: 2 }, { id: mockNftId2, balance: 3 }]);
