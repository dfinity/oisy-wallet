...
import { USDT_TOKEN } from '$env/tokens/tokens-evm/tokens-base/tokens-erc20/tokens.usdt.env';
import type { RequiredEvmErc20Token } from '$evm/types/erc20';

const BASE_ERC20_TOKENS_SEPOLIA: RequiredEvmErc20Token[] = [SEPOLIA_USDC_TOKEN, SEPOLIA_EURC_TOKEN];

const BASE_ERC20_TOKENS_MAINNET: RequiredEvmErc20Token[] = [USDC_TOKEN, USDT_TOKEN, EURC_TOKEN];
