...
import ethereumIconTransparent from '$lib/assets/networks/ethereum-mainnet.svg';
import sepoliaIconTransparent from '$lib/assets/networks/ethereum-sepolia.svg';
