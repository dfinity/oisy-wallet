...
import solDevnetIconTransparent from '$lib/assets/networks/solana-devnet.svg';
import solMainnetIconTransparent from '$lib/assets/networks/solana-mainnet.svg';
...
export const SOLANA_MAINNET_NETWORK: SolanaNetwork = {
	...
	icon: solMainnetIconTransparent,
