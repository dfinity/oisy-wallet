...
import arbitrumMainnetIconTransparent from '$lib/assets/networks/arbitrum-mainnet.svg';
import arbitrumSepoliaIconTransparent from '$lib/assets/networks/arbitrum-sepolia.svg';
...
export const ARBITRUM_MAINNET_NETWORK: EthereumNetwork = {
	...
	name: 'Arbitrum',
	chainId: 42161n,
	icon: arbitrumMainnetIconTransparent,
...
export const ARBITRUM_SEPOLIA_NETWORK: EthereumNetwork = {
	...
	chainId: 421614n,
	icon: arbitrumSepoliaIconTransparent,
