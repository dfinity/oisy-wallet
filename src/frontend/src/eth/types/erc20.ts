...
import type { RequiredToken, Token, TokenMetadata, TwinToken } from '$lib/types/token';
...
export type Erc20Contract = Erc20ContractAddress & TwinToken & { exchange: Exchange };
