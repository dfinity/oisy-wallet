...
export type Erc1155Token = Erc1155Contract &
	Omit<Token, 'network' | 'standard' | 'name' | 'symbol'> & { network: EthereumNetwork;
	standard: Erc1155Standard; name?: string; symbol?: string; };
...
export type Erc1155Metadata = Partial<Pick<TokenMetadata, 'name' | 'symbol'>> & Pick<TokenMetadata, 'decimals'>;
