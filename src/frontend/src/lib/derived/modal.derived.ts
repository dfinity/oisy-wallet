...
export const modalKaspaReceive: Readable<boolean> = derived(
	modalStore,
	($modalStore) => $modalStore?.type === 'kaspa-receive'
);
...
export const modalKaspaTransaction: Readable<boolean> = derived(
	modalStore,
	($modalStore) => $modalStore?.type === 'kaspa-transaction'
);
