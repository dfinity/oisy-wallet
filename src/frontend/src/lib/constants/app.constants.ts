...
export const ESCROW_CANISTER_ID = LOCAL
	? import.meta.env.VITE_LOCAL_ESCROW_CANISTER_ID
	: STAGING
		? import.meta.env.VITE_STAGING_ESCROW_CANISTER_ID
		: BETA
			? import.meta.env.VITE_BETA_ESCROW_CANISTER_ID
			: import.meta.env.VITE_IC_ESCROW_CANISTER_ID;
