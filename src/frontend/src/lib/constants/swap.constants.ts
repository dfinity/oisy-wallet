...
export const SUPPORTED_CROSS_SWAP_NETWORKS: Record<NetworkId, NetworkId[]> = {
	...
	[ETHEREUM_NETWORK_ID]: SUPPORTED_CROSS_SWAP_EVM_NETWORK_IDS,
	[ARBITRUM_MAINNET_NETWORK_ID]: SUPPORTED_CROSS_SWAP_EVM_NETWORK_IDS,
	[BSC_MAINNET_NETWORK_ID]: SUPPORTED_CROSS_SWAP_EVM_NETWORK_IDS,
	[POLYGON_MAINNET_NETWORK_ID]: SUPPORTED_CROSS_SWAP_EVM_NETWORK_IDS,
	[BASE_NETWORK_ID]: SUPPORTED_CROSS_SWAP_EVM_NETWORK_IDS
};
