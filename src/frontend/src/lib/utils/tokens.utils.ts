...
export const sortTokens = <T extends Token>({
	...
	return [
		...
		...otherTokens.sort((a, b) => {
			// TODO: Create a constant for the deprecated SNSs that can be used in the dapp and the `build.tokens.sns.mjs` script. This requires converting the script to TypeScript.
