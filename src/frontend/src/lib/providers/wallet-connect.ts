...
export abstract class BaseWalletConnectProvider {
    ...
    protected abstract buildNamespaces(params: Web3WalletTypes.SessionProposal['params']): Record<string, WalletConnectNamespace>;
    ...
    protected async disconnectActiveSessions(): Promise<void> {
        ...
        const promises = Object.entries(this.web3wallet.getActiveSessions()).map(disconnectExistingSessions);
