<script lang="ts">
	...
	// Testing harness - DO NOT MERGE. Deliberately not translated: the card never reaches a user.
	// Reuses the Settings cards for their layout - the harness styles nothing of its own.
...
<SettingsCard>
	{#snippet title()}Unavailable Ledger or Index Canister Simulation{/snippet}
