...
<div class="ufo-wrapper">
	<svg class="ufo" width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		<!-- Define a mask that subtracts (cuts out) the window shapes from the UFO body -->
		<defs>
			<mask id="window-mask">
				<!-- Full area white -->
				<rect width="100%" height="100%" fill="white" />
				<!-- Subtract window areas by drawing them in black -->
				<g fill="black">
					<path d="M7.21429 4.95823C7.60481 5.34876 8.23798 5.34876 8.6285 4.95823C9.01903 4.56771 9.01903 3.93455 8.6285 3.54402C8.23798 3.1535 7.60481 3.1535 7.21429 3.54402C6.82377 3.93455 6.82377 4.56771 7.21429 4.95823Z"/>
					<path d="M11.4571 9.2014C11.0666 9.59192 10.4334 9.59192 10.0429 9.2014C9.65238 8.81087 9.65238 8.17771 10.0429 7.78718C10.4334 7.39666 11.0666 7.39666 11.4571 7.78718C11.8476 8.17771 11.8476 8.81087 11.4571 9.2014Z"/>
					<path d="M15.6998 12.0295C15.3093 12.42 14.6761 12.42 14.2856 12.0295C13.8951 11.639 13.8951 11.0058 14.2856 10.6153C14.6761 10.2248 15.3093 10.2248 15.6998 10.6153C16.0903 11.0058 16.0903 11.639 15.6998 12.0295Z"/>
				</g>
			</mask>
		</defs>

		<!-- Additional UFO details (dome, etc.) -->
		<path
				class="dome"
		...
		<!-- UFO Body with the mask subtracting the window areas -->
		<g opacity="0.4">
			<path
		...
		<!-- Animated Windows drawn on top, now with the same color as the dome (#0066FF) -->
		<g class="window1" fill="white">
			<path d="M7.21429 4.95823C7.60481 5.34876 8.23798 5.34876 8.6285 4.95823C9.01903 4.56771 9.01903 3.93455 8.6285 3.54402C8.23798 3.1535 7.60481 3.1535 7.21429 3.54402C6.82377 3.93455 6.82377 4.56771 7.21429 4.95823Z"/>
		</g>
		<g class="window2" fill="white">
			<path d="M11.4571 9.2014C11.0666 9.59192 10.4334 9.59192 10.0429 9.2014C9.65238 8.81087 9.65238 8.17771 10.0429 7.78718C10.4334 7.39666 11.0666 7.39666 11.4571 7.78718C11.8476 8.17771 11.8476 8.81087 11.4571 9.2014Z"/>
		</g>
		<g class="window3" fill="white">
			<path d="M15.6998 12.0295C15.3093 12.42 14.6761 12.42 14.2856 12.0295C13.8951 11.639 13.8951 11.0058 14.2856 10.6153C14.6761 10.2248 15.3093 10.2248 15.6998 10.6153C16.0903 11.0058 16.0903 11.639 15.6998 12.0295Z"/>
		</g>
