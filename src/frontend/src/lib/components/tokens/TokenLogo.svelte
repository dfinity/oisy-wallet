...
<div class="relative">
	...
	{#if badge?.type === 'tokenCount' && badge.count > 0}
		<span
			class="-right-2.5 bottom-0 h-6 w-6 text-sm font-semibold absolute flex items-center justify-center rounded-full border-[0.5px] border-tertiary bg-primary text-black"
