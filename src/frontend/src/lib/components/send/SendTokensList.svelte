<script lang="ts">
	...
	import { sortedNetworkTokensUi_POTENTIAL_RE_RENDER } from '$lib/derived/network-tokens.derived';
	...
	let tokens: TokenUi[];
	$: tokens = $sortedNetworkTokensUi_POTENTIAL_RE_RENDER.filter(({ id: tokenId }) =>
