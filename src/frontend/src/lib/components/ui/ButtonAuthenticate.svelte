...
<button
	on:click
	class="login-button gap-4 rounded-2xl py-3 text-lg leading-6 font-bold sm:px-12 text-primary-inverted flex w-full items-center justify-center bg-brand-primary"
