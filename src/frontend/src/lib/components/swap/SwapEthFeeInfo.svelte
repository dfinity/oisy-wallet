<script lang="ts">
	...
	const { sourceTokenSymbol } = getContext<SwapContext>(SWAP_CONTEXT_KEY);
...
{#if nonNullish(feeSymbol) && $sourceTokenSymbol !== feeSymbol}
	<MessageBox styleClass="sm:text-sm" testId={SEND_FEE_INFO}>
		<Html
