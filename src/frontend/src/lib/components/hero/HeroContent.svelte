...
<div
	class="bg-pos-0 p-6 ease-in-out text-primary-inverted flex h-full w-full flex-col content-center items-center justify-center rounded-[40px] bg-brand-primary bg-linear-to-b text-center transition-all duration-500"
