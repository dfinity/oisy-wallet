...
<div
	class="bg-pos-0 bg-brand-primary flex h-full w-full flex-col content-center items-center justify-center rounded-[24px] p-3 text-center transition-[background-position,background-size] duration-500 ease-in-out md:rounded-[28px] md:p-5"
