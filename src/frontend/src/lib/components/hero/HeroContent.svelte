...
<div
	class="flex h-full w-full flex-col content-center items-center justify-center rounded-[40px] bg-brand-primary bg-linear-to-b from-brand-primary via-absolute-blue bg-pos-0 p-6 text-center text-white transition-all duration-500 ease-in-out"
