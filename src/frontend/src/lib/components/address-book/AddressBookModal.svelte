<script lang="ts">
	...
	let controller: ReturnType<typeof makeController> | undefined;
	  ...
	  controller = makeController({
	   ...
	   identity: $authIdentity,
	    ...
	    modal,
	    track: {
	      createSuccess: TRACK_CONTACT_CREATE_SUCCESS, createError: TRACK_CONTACT_CREATE_ERROR,
	      updateSuccess: TRACK_CONTACT_UPDATE_SUCCESS, updateError: TRACK_CONTACT_UPDATE_ERROR,
	      deleteSuccess: TRACK_CONTACT_DELETE_SUCCESS, deleteError: TRACK_CONTACT_DELETE_ERROR,
	      avatarUpdateSuccess: TRACK_AVATAR_UPDATE_SUCCESS, avatarUpdateError: TRACK_AVATAR_UPDATE_ERROR,
	      avatarDeleteSuccess: TRACK_AVATAR_DELETE_SUCCESS, avatarDeleteError: TRACK_AVATAR_DELETE_ERROR
	    }
	  });
	});
  ...
  >
	...
	{:else if $currentStepName === AddressBookSteps.EDIT_CONTACT_NAME}
	  ...
	  <EditAddressStep
		address={
		  nonNullish($currentAddressIndex)
