...
<div class="relative">
	...
	<div
		class="border-secondary bg-surface absolute top-0 right-0 bottom-0 left-0 m-auto flex h-9 w-9 items-center justify-center rounded-lg border border-solid shadow-sm"
	>
		<IconMoveDown />
	</div>
