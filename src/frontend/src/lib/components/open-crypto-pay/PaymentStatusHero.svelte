...
{#if nonNullish($selectedToken) && nonNullish($data?.displayName)}
	<div
		class="bg-pos-0 overflow-hidden mb-6 flex h-full w-full flex-col content-center items-center justify-center rounded-[24px] pt-6 text-center text-primary-inverted md:rounded-[28px]"
