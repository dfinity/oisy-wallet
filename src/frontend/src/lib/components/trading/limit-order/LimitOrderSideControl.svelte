...
<div class="flex rounded-lg border border-disabled bg-secondary">
	<button
		class="flex flex-1 items-center justify-center gap-1.5 rounded-none rounded-s-lg py-3 text-sm font-semibold transition-colors"
	...
	<button
		class="flex flex-1 items-center justify-center gap-1.5 rounded-none rounded-e-lg py-3 text-sm font-semibold transition-colors"
