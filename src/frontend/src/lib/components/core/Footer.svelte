...
<footer
	class="max-w-screen-2.5xl pointer-events-none z-1 mx-auto flex w-full flex-1 flex-col items-center justify-end px-4 pt-12 pb-5 sm:flex-1 sm:flex-grow sm:flex-row sm:items-end sm:justify-between sm:px-8 lg:fixed lg:inset-x-0 lg:bottom-0"
