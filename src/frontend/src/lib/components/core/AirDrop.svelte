...
<p class="font-bold text-center bg-white rounded-lg m-2 px-2 py-1.5">
	<IconCelebrate /> <span class="px-0.5">Participate in $100K ICP ERC-20 Airdrop by solving a quiz about the Internet Computer</span>
