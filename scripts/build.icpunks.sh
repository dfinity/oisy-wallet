...
print_help() {
  cat <<-EOF
	...
	The files are installed at the locations defined for 'icpunks' in 'dfx.json'.
	EOF
}
...
# Success
cat <<EOF
SUCCESS: The icpunks installation files have been created:
icpunks candid:       $CANDID_FILE
EOF
