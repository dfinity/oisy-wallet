import { AMOUNT_DATA, AMOUNT_INPUT, DESTINATION_INPUT, IN_PROGRESS_MODAL, MAX_BUTTON, NAVIGATION_ITEM_EXPLORER, RECEIVE_TOKENS_MODAL_COPY_ICP_ACCOUNT_ID_BUTTON, RECEIVE_TOKENS_MODAL_DONE_BUTTON, RECEIVE_TOKENS_MODAL_OPEN_BUTTON, REVIEW_FORM_SEND_BUTTON, SEND_FORM_NEXT_BUTTON, SEND_TOKENS_MODAL_OPEN_BUTTON, TOKEN_CARD_ICP } from '$lib/constants/test-ids.constants';
...
export class FlowPage extends HomepageLoggedIn {
  ...
  async receiveTokens(): Promise<void> {
    ...
    const accountId = await this.clickCopyButtonByTestId(RECEIVE_TOKENS_MODAL_COPY_ICP_ACCOUNT_ID_BUTTON);
