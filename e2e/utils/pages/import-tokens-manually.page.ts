import {
	AMOUNT_INPUT,
	DESTINATION_INPUT,
	IMPORT_TOKENS_BUTTON,
	IMPORT_TOKENS_NETWORK_SELECTOR,
	IN_PROGRESS_MODAL,
...
export class FlowPage extends HomepageLoggedIn {
	...
	async importErc(): Promise<void> {
		await this.clickByTestId({ testId: MANAGE_TOKENS_BUTTON });
		await this.clickByTestId({ testId: IMPORT_TOKENS_BUTTON });
		await this.clickByTestId({ testId: IMPORT_TOKENS_NETWORK_SELECTOR });
